...
/**
 * The hoal of this program is to obtain a HEATHLY
...
public class sustainPlusPlus {
	...
	public static void main(String[] args) {
		...
		/**
		 * If abstaction is the definition of beauty
		...
		for (Ghost g : findings) {
			...
			if (me.isHappy()) {
				if (parents[0] == null) {
					...
					//and will never be happy eanyway
				}
			}
			me.removeFamily(g);
		}
		...
		*/
		...
		me.sayTo("Anithing inconvenient, I shall erase for you.", you);
